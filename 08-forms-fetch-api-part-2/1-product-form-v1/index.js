...
export default class ProductForm {
      ...
      <div class="product-form">
        <form class="form-grid" data-element="productForm">
          ...
          <div class="form-group form-group__wide">
            ...
            <ul class="sortable-list" data-element="imageListContainer">${this.createImagesList()}</ul>
  ...
  createImagesList() {
    return this.formData.images.map(({url, source}) => this.getImageItem(url, source)).join('');
  }
